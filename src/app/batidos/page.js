    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-indigo-50 relative">
      ...
      <div className="flex justify-between items-center px-6 mt-2 gap-2">
        <Button
          ...
          className="bg-gradient-to-r from-green-300 to-emerald-300 hover:from-green-400 hover:to-emerald-400 text-gray-800 font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
        >

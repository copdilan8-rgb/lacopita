...
const TABLE_NAME = "sandwichs";

export default function SandwichsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-green-50 to-lime-100 relative">
      ...
      <div className="flex justify-between items-center px-6 mt-2 gap-2">
        <Button
          ...
          className="bg-gradient-to-r from-green-300 to-lime-300 hover:from-green-400 hover:to-lime-400 text-gray-800 font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
        >
        ...
        <Button
          onClick={handleAdd}
          className="bg-gradient-to-r from-green-400 to-lime-400 hover:from-green-500 hover:to-lime-500 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
        >

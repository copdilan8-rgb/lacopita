...
export default function RefrescosPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-cyan-50 to-blue-100 relative">
      ...
      <div className="flex justify-between items-center px-6 mt-2 gap-2">
        <Button
          ...
          className="bg-gradient-to-r from-cyan-300 to-blue-300 hover:from-cyan-400 hover:to-blue-400 text-gray-800 font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
        >

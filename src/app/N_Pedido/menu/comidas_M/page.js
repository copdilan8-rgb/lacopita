...
export default function ComidasMenuPage() {
  ...
  const handleAgregar = (producto) => {
    ...
    const existente = pedidoActual.items.find(
      (i) => i.id === producto.id && i.categoria === "comidas"
    );
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-yellow-50 to-orange-100">
      ...
      <div className="px-6 pt-4 flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800">🍛 Comidas</h1>
